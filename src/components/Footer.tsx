            ...
            <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
              ...
              <div className="max-w-lg">
                ...
                <div className="flex items-center gap-4">
                  <a href="#" className="text-text-light hover:text-text-dark transition-colors" aria-label="Facebook">
                  ...
                  <a href="#" className="text-text-light hover:text-text-dark transition-colors" aria-label="TikTok">
