            ...
            <div className="flex flex-col md:flex-row justify-between gap-12 mb-16">
              ...
              <div className="max-w-lg">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a href="https://www.youtube.com/@MitLivMed" className="text-text-light hover:text-text-dark transition-colors" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
              ...
              <div className="flex flex-row gap-12">
                ...
                <div>
                  ...
                  <nav className="flex flex-col gap-3 text-sm font-body text-text-medium">
                    <Link to="/trivsels-gruppe" className="hover:text-text-dark transition-colors">
                      Trivsels Grupper
                    </Link>
