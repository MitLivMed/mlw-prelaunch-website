// Source: Danmarks Adresser Web API (api.dataforsyningen.dk), fetched 2026-09-19.
// Regenerate by joining GET /postnumre (kommuner[]) with GET /kommuner (region.navn),
// stripping the "Region " prefix. Most postal codes resolve to one region; a small
// number straddle a kommune border and genuinely belong to two regions (array value).
export const POSTAL_CODE_REGIONS: Record<string, string | string[]> = {
  "1050": "Hovedstaden",
  "1051": "Hovedstaden",
  "1052": "Hovedstaden",
  "1053": "Hovedstaden",
